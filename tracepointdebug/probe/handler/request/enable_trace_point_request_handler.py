...
from tracepointdebug.probe.request.enable_trace_point_request import EnableTracePointRequest
from tracepointdebug.probe.response.enable_trace_point_response import EnableTracePointResponse
